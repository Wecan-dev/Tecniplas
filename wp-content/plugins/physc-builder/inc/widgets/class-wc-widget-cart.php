...
class Physc_Custom_WC_Widget_Cart extends WC_Widget_Cart {
	...
	public function widget( $args, $instance ) {
		...
		echo '<span class="cart-items-number"><i class="icon-bag"></i>';
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_attr_e( 'Title:', 'physc-builder' ) ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'hide_if_empty' ) ); ?>"><?php esc_attr_e( 'Hide if cart is empty', 'physc-builder' ); ?></label>
		</p>
