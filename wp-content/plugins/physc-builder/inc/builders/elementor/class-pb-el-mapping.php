<?php
/**
 * PhyscBuilders Elementor Mapping class
 *
 * @version     1.0.0
 * @author      Physcode
...
if ( !class_exists( 'PhyscBuilder_El_Mapping' ) ) {
	/**
	 * Class PhyscBuilder_El_Mapping
	 */
	class PhyscBuilder_El_Mapping {
		...
		private static function _mapping_types( $type ) {
			...
			return apply_filters( 'physc-builder/el-mapping-types', $mapping[$type] );
		}
			...
			foreach ( $params as $param ) {
				...
				switch ( $param['type'] ) {
					...
					case 'attach_images':
						...
						break;
					case 'vc_link':
						$field['placeholder'] = __( 'https://your-link.com', 'physc-builder' );
					...
					case 'radio_image':
						...
						break;
					default:
						$field = array_merge( $field, apply_filters( 'physc-builder/field-el-param', array(), $type ) );
						break;
				}
