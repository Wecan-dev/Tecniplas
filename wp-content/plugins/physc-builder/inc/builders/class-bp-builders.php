...
if ( ! class_exists( 'PhyscBuilders_Modules' ) ) {
	/**
	 * Class PhyscBuilders_Modules
	 */
	class PhyscBuilders_Modules {

		/**
		 * PhyscBuilders_Modules constructor.
		 */
		...
		public function _input_fields( $widget, $return, $instance ) {
			...
			if ( strpos( $widget->id_base, 'physc-builder' ) !== false ) {
				return;
			}
            ...
            <p>
				<?php printf(
					...
					esc_html__( 'Extra Class', 'physc-builder' )
				) ?>
				<?php printf(
