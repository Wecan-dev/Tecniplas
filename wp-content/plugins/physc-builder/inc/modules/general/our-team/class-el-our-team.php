...
if ( ! class_exists( 'PhyscBuilder_El_Our_Team' ) ) {
	/**
	 * Class PhyscBuilder_El_Icon_Box
	 */
	class PhyscBuilder_El_Our_Team extends PhyscBuilder_El_Widget {
		...
		protected function _register_controls() {
			$this->start_controls_section(
				'el-our-team', [ 'label' => esc_html__( 'Our Team', 'physc-builder' ) ]
			);
