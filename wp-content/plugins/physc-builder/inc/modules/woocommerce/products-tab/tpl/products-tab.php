...
if ( count( $items_tab ) > 0 ) {
	...
	foreach ( $items_tab as $item_tab ) {
		...
		if ( $show == '' ) {
			$title_tab = esc_attr__( 'All', 'physc-builder' );
		} elseif ( $show == 'featured' ) {
			$title_tab = esc_attr__( 'Featured Products', 'physc-builder' );
		} elseif ( $show == 'onsale' ) {
			$title_tab = esc_attr__( 'On-sale Products', 'physc-builder' );
		} else {
			if ( $product_cat ) {
				...
				$title_tab = esc_attr__( 'All Product', 'physc-builder' );
			}
		}
